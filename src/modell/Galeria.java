...
//            Festmeny f3 = new Festmeny(LocalDate.parse("2023-01-01"), "készítő2", "cím1");
            ...
            //készítő és cím Fájl
            Festmeny f4 = new Festmeny(new File("src/res/kep.txt"), "készítő5", "cím4");
            
            //készítő és cím + Fájl és MAI dátum
            Festmeny f5 = new Festmeny(new File("src/res/kep.txt"), LocalDate.now(), "készítő4", "cím5");
            
            //készítő és cím + Fájl és LÉTEZŐ dátum
            Festmeny f6 = new Festmeny(new File("src/res/kep.txt"), LocalDate.of(2021, 05, 13), "készítő7", "cím7");
